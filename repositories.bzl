def build_repos():
    ...
    native.new_git_repository(
        name = "googletest",
        build_file = str(Label("//org_deepmind_lab:googletest.BUILD")),
    ...
    native.new_http_archive(
        name = "eigen_archive",
        build_file = str(Label("//org_deepmind_lab:eigen.BUILD")),
    ...
    native.new_http_archive(
        name = "glib_archive",
        build_file = str(Label("//org_deepmind_lab:glib.BUILD")),
    ...
    native.new_http_archive(
        name = "jpeg_archive",
        build_file = str(Label("//org_deepmind_lab:jpeg.BUILD")),
    ...
    native.new_http_archive(
        name = "libxml_archive",
        build_file = str(Label("//org_deepmind_lab:libxml.BUILD")),
    ...
    native.new_http_archive(
        name = "png_archive",
        build_file = str(Label("//org_deepmind_lab:png.BUILD")),
    ...
    native.new_http_archive(
        name = "zlib_archive",
        build_file = str(Label("//org_deepmind_lab:zlib.BUILD")),
    ...
    native.new_local_repository(
        name = "lua_system",
        build_file = str(Label("//org_deepmind_lab:lua.BUILD")),
        path = "/usr",
    )
    native.new_local_repository(
        name = "sdl_system",
        build_file = str(Label("//org_deepmind_lab:sdl.BUILD")),
        path = "/usr",
    )
    native.new_local_repository(
        name = "python_system",
        build_file = str(Label("//org_deepmind_lab:python.BUILD")),
        path = "/usr",
    )
