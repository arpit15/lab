def build_repos():
    ...
    native.new_git_repository(
        name = "googletest",
        build_file = str(Label("//:googletest.BUILD")),
    ...
    native.new_http_archive(
        name = "glib_archive",
        build_file = str(Label("//:glib.BUILD")),
    ...
    native.new_http_archive(
        name = "libxml_archive",
        build_file = str(Label("//:libxml.BUILD")),
    ...
    native.new_local_repository(
        name = "lua_system",
        build_file = str(Label("//:lua.BUILD")),
        path = "/usr",
    )
    native.new_local_repository(
        name = "sdl_system",
        build_file = str(Label("//:sdl.BUILD")),
        path = "/usr",
    )
    native.new_local_repository(
        name = "python_system",
        build_file = str(Label("//:python.BUILD")),
        path = "/usr",
    )
